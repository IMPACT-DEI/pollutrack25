                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  ...
                                  provider.getDataOfDay(provider.currentDate.subtract(const Duration(days: 1)));
                                },
                                child: const Icon(
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  ...
                                  provider.getDataOfDay(provider.currentDate.add(const Duration(days: 1)));
                                },
                                child: const Icon(
                                  Icons.navigate_next,
                                ),
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () async{
                await Navigator.of(context).push(MaterialPageRoute(builder:  (context) => Profile()));
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Consumer<DataProvider>(builder: (context, provider, child) {
                      return Text('Name updated! New name: ${provider.name} ${provider.surname}');
                    }),
